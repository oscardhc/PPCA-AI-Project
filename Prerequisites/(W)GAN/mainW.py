...
if __name__ == '__main__':
    ...
    optG = optim.RMSprop(G.parameters(), lr=0.0002)
    optD = optim.RMSprop(D.parameters(), lr=0.0002)
    ...
    for epoch in range(658, numE + 1):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            errD = -torch.mean(D(real)) + torch.mean(D(fake))
            errD.backward()
